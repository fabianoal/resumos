...
* $n^{-1}\sum_{i=1}^n (\hat{\beta}_0 + \hat{\beta}_1 x_i ) = \sum_{i=1}^n \hat{y} n^{-1}(1,66 + 1,5 * 1 +  1,66 + 1,5 * 2 + 1,66 + 1,5 * 3) = n^{-1}(3,16 + 4,66 + 6,16)$
* $\bar{\boldsymbol{y}} = $
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzNTkxMzUwNiw2MDIyNzE2MjIsNTc5OD
